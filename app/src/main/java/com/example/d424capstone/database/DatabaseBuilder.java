...
import com.example.d424capstone.dao.ContactMessageDAO;
...
@Database(entities = {User.class, Cat.class, StoreItem.class, CartItem.class, Order.class, SocialPost.class, PremiumStorefront.class, ContactMessage.class}, version = 5)
